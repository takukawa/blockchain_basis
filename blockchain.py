...
class Blockchain(object):
    ...
    def proof_of_work(self, last_proof):
        ...
        - p is the orevious proof, and p' is the new proof
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            # Chech that the Proof of Work is corrent
    ...
    def resolve_conflicts(self):
        ...
        :return: <bool> True if out chain was relpaced, False if not
        """
...
def consensus():
    ...
    message = 'Our chain '
    message += 'was replaced' if replaced else 'is authoritative'
